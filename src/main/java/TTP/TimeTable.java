...
public class TimeTable {        //
    ...
    public void exportTimeTable(String filepath) {
        ...
        System.arraycopy(lectureArr1stSlotMode, 0, bookData[5], 0, lectureArr1stSlotMode.length);
        System.arraycopy(lectureArr1stSlotGroups, 0, bookData[6], 0, lectureArr1stSlotGroups.length);
        System.arraycopy(lectureArr2ndSlotName, 0, bookData[8], 0, lectureArr2ndSlotName.length);
        System.arraycopy(lectureArr2ndSlotLecturer, 0, bookData[9], 0, lectureArr2ndSlotLecturer.length);
        System.arraycopy(lectureArr2ndSlotMode, 0, bookData[10], 0, lectureArr2ndSlotMode.length);
        System.arraycopy(lectureArr2ndSlotGroups, 0, bookData[11], 0, lectureArr2ndSlotGroups.length);
